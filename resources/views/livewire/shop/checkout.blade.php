<div>
    ...
    <div class="mt-3">
        ...
        <div class="mb-3 p-3 notice">
            <p class=""><strong>{{ __('Important!') }}
                </strong>{{ __('We do not share your personal information until you confirm a quotation. Once you select the most suitable quotation, your details will be shared with the relevant service providers.') }}
            </p>
        </div>
        <div class="mb-3">
            <div class="py-2">
        ...
        <div class="fixed-bottom">
           <button class="btn btn-warning btn-lg rounded-0 w-100" wire:click="placeOrder" wire:loading.attr="disabled">
